...
def separate_gyr_acc(data_array):
    return np.array([data_array[0:3], data_array[3:6]])
...
def low_pass_filter(gyr_angle, acc_coord):
    return gyr_angle + (0.98 * gyr_angle + 0.02 * acc_coord)
...
def main(filename1, filename2):
    with open(filename1, 'r') as file1, open(filename2, 'r') as file2:
        ...
        for data in lines(file1, file2):
            [data_1, data_2] = data
            [new_gyr_angles_1, acc_coords_1] = data_1
            [new_gyr_angles_2, acc_coords_2] = data_2
            [old_gyr_angles_1, old_gyr_angles_2, quat_1, quat_2] = double_complementary_filter(old_gyr_angles_1, new_gyr_angles_1, acc_coords_1, old_gyr_angles_2, new_gyr_angles_2, acc_coords_2)
...
if __name__ == '__main__':
    main('parado_10s (1).txt', 'vertical_p_horizontal_10s (2).txt')